...
const AIToolsPromoCard: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="relative cursor-pointer overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500/80 via-fuchsia-500/80 to-pink-500/80 p-[1.5px] shadow-xl shadow-purple-900/20 hover:shadow-2xl hover:shadow-fuchsia-600/30 transition-all duration-500 backdrop-blur-xl"
    >
      <div className="relative overflow-hidden rounded-[14px] bg-gradient-to-br from-purple-800/85 via-fuchsia-800/85 to-pink-800/85 backdrop-blur-xl p-5 border border-white/20">
        {/* Animated background */}
        <motion.div
