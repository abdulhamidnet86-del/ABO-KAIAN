...
const LiveStreamPromoCard: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="relative cursor-pointer overflow-hidden rounded-2xl bg-gradient-to-br from-red-500/80 via-rose-600/80 to-pink-700/80 p-[1.5px] shadow-xl shadow-red-900/20 hover:shadow-2xl hover:shadow-rose-600/30 transition-all duration-500 backdrop-blur-xl"
    >
      <div className="relative overflow-hidden rounded-[14px] bg-gradient-to-br from-red-600/85 via-rose-700/85 to-pink-800/85 backdrop-blur-xl p-5 border border-white/20">
