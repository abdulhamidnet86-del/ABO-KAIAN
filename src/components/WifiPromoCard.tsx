...
const WifiPromoCard: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="cursor-pointer group relative overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-400/80 via-blue-500/80 to-indigo-600/80 p-[1.5px] shadow-xl shadow-blue-900/20 hover:shadow-2xl hover:shadow-cyan-500/30 transition-all duration-500 backdrop-blur-xl"
    >
      <div className="relative overflow-hidden rounded-[14px] bg-gradient-to-br from-cyan-600/85 via-blue-700/85 to-indigo-800/85 backdrop-blur-xl p-5 border border-white/20">
